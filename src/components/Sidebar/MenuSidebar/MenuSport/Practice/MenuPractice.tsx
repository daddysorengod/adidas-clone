...
const menu = {
    title: 'Chạy',
    items: [
        {item:'Tất cả các sản phẩm dành cho Tập luyện',link:''},
        {item:'Tập luyện | Trag chủ',link:''},
        {item:'Giày',link:''},
        {item:'QUần áo',link:''},
        {item:'Phụ kiện',link:''},
        {item:'Dòng sản phẩm clima',link:''},
        {item:'Dòng sản phẩm techfit',link:''},
        {item:'Dòng sản phẩm essentials',link:''},
    ]
}

const MenuPractice = (props: any) => {
